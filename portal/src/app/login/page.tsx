    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center px-4">
      <div className="w-full max-w-md">
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full bg-gray-700 border border-gray-600 rounded-lg px-4 py-2.5 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        ...
        <p className="text-center text-gray-600 text-xs mt-6">
          Sistema exclusivo para clientes licenciados
        </p>
      </div>
    </div>
  );
